...
class _BodyState extends State<Body> {
  ...
  List<Map<String, String>> splashData = [
    {"text": "내 물건들은 내가 알아야 한다", "image": "assets/images/splash_1.png"},
    {"text": "어디에서 뭘 샀고", "image": "assets/images/splash_2.png"},
    {"text": "그 물건들을 어디에 정리했는지!", "image": "assets/images/splash_3.png"},
  ];
  @override
